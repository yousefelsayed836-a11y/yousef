/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d955b61f8b603dd878abd60d061b3342)
...
interface __BaseEnv_Env {
	...
	WATCHDOG_SCRIPT_NAME: string;
	WATCHDOG_REQUESTS_ALERT: string;
	WATCHDOG_REQUESTS_KILL: string;
	WATCHDOG_DURATION_ALERT_GBS: string;
	WATCHDOG_DURATION_KILL_GBS: string;
	WATCHDOG_ROWS_WRITTEN_ALERT: string;
	WATCHDOG_ROWS_WRITTEN_KILL: string;
	WATCHDOG_ROWS_READ_ALERT: string;
	WATCHDOG_ROWS_READ_KILL: string;
	SYNC_HUB: DurableObjectNamespace<import("./src/index").SyncHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SyncHub";
	}
